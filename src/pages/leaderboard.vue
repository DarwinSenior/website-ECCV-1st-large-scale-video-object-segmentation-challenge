...
#page-leaderboard
  ...
  section.section#display-section: .container.content
    ...
    .section
      ...
      table#team-report
        ...
        tr
          ...
          td N/A
    .section
      h1.title.is-4 <strong>Detailed Information</strong>
      h1.title.is-5 <strong>1st</strong>: Jono
      h1.title.is-6 Jonathon Luiten, Paul Voigtlaender, Bastian Leibe
      h1.title.is-6 Computer Vision Group, RWTH Aachen University, Germany
    ...
    .section
      h1.title.is-5 <strong>2nd</strong>: speeding_zZ
      h1.title.is-6 Zilong Huang*, Qiang Zhou*, Lichao Huang, Han Shen, Yongchao Gong, Chang Huang, Wenyu Liu, Xinggang Wang (*equal contribution & interns of Horizon Robotics)
      h1.title.is-6 Huazhong University of Science and Technology, Horizon Robotics.
    ...
    .section
      h1.title.is-5 <strong>3rd</strong>: mikirui
      h1.title.is-6 Huaijia Lin*, Ruizheng Wu*, Xiaogang Xu, Xiaojuan Qi, Jiaya Jia (* indicates equal contribution)
      h1.title.is-6 The Chinese University of Hong Kong & Tencent YouTu X-Lab
    ...
    .section
      h1.title.is-5 <strong>4th</strong>: hi.nineare
      h1.title.is-6 University of Texas at Austin & Preferred Networks
    ...
    .section
      h1.title.is-5 <strong>5th</strong>: sunpeng
      h1.title.is-6 Zhejiang University & Renmin University of China & Institute of Remote Sensing and Digital Earth (RADI) & Chinese Academy of Sciences (CAS)
    ...
    .section
      h1.title.is-5 <strong>5th</strong>: random_name
      h1.title.is-6 ByteDance AI Lab
    ...
    .section
      h1.title.is-5 <strong>7th</strong>: kduarte
    .section
      h1.title.is-5 <strong>8th</strong>: SnowFlower
      h1.title.is-6 Qiong WANG
      h1.title.is-6 Univ Rennes, INSA Rennes, CNRS, IETR (Institut d'Electronique et de Telecommunication de Rennes) - UMR 6164, F-35000 Rennes, France
